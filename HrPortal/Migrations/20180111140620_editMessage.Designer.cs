...
namespace HrPortal.Migrations
{
    ...
    [Migration("20180111140620_editMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HrPortal.Models.Message", b =>
                {
                    ...
                    b.Property<string>("FromResumeId");
                    ...
                    b.HasIndex("FromResumeId");

                    b.HasIndex("ToCompanyId");

                    b.HasIndex("ToResumeId");
            ...
            modelBuilder.Entity("HrPortal.Models.Message", b =>
                {
                    b.HasOne("HrPortal.Models.Company", "FromCompany")
                        .WithMany()
                        .HasForeignKey("FromCompanyId");

                    b.HasOne("HrPortal.Models.Resume", "FromResume")
                        .WithMany()
                        .HasForeignKey("FromResumeId");

                    b.HasOne("HrPortal.Models.Company", "ToCompany")
                        .WithMany()
                        .HasForeignKey("ToCompanyId");

                    b.HasOne("HrPortal.Models.Resume", "ToResume")
                        .WithMany()
                        .HasForeignKey("ToResumeId");
                });
